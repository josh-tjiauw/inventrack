...
psql "$env:DATABASE_URL" -v ON_ERROR_STOP=1 -f database/migrations/004_audit_request_ids.sql
```
...
- `004_audit_request_ids.sql` adds `audit_logs.request_id` and an index for API request correlation.
